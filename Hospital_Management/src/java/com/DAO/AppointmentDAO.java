...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			...
			String sql = "insert into appointment(user_id,fullname,gender,age,appoint_date,email,ph_no,diseases,doctor_id,address,status) values(?,?,?,?,?,?,?,?,?,?,?)";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, ap.getUserId());
			ps.setString(2, ap.getFullName());
			ps.setString(3, ap.getGender());
			ps.setString(4, ap.getAge());
			ps.setDate  (5, java.sql.Date.valueOf(ap.getAppoinDate()));
			...
			throw new RuntimeException(e); // or at least return false after printing
		}
